class Battle
  ...
  def player1_attack
    ...
    puts "Player1 dealt #{dealt_damage} damage to Player2 #{hp_left} HP remaining"
    return "Player1 wins" if hp_left <= 0
    player2_attack
  end
  ...
  def player2_attack
    ...
    puts "Player2 dealt #{dealt_damage} damage to Player1 #{hp_left} HP remaining"
    return "Player2 wins" if hp_left <= 0
    player1_attack
  end
